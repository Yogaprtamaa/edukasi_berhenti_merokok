    ...
    <div class="mx-auto max-w-xl">
        ...
        <div class="card">
            <form action="{{ route('admin.professionals.update', $professional) }}" method="POST" class="space-y-6">
                ...
                <div>
                    <label class="editorial-label mb-2 block">Nomor Lisensi</label>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <label for="is_verified" class="editorial-label cursor-pointer">Tandai sebagai terverifikasi</label>
                </div>
