...
<body class="min-h-screen bg-[#F9F8F6]">
    ...
    @auth
        @php
            ...
            $navIcons = [
                'Dashboard' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 5a1 1 0 0 1 1-1h5v6H4V5Zm10-1h5a1 1 0 0 1 1 1v3h-6V4ZM4 14h6v6H5a1 1 0 0 1-1-1v-5Zm10-2h6v7a1 1 0 0 1-1 1h-5v-8Z"/></svg>',
                'Users' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M16 19a4 4 0 0 0-8 0M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm6.5 8a3.5 3.5 0 0 0-2.8-3.43M17 5.2a3 3 0 0 1 0 5.6"/></svg>',
                'Profesional' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 14.5a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm-7 6a7 7 0 0 1 14 0M12 7v5m-2.5-2.5h5"/></svg>',
                'Konten' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 4h9l3 3v13H6V4Zm8 0v4h4M9 12h6M9 16h6M9 8h2"/></svg>',
                'Forum' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 6h14v9H8l-3 3V6Zm4 4h6m-6 3h4"/></svg>',
                'Pembayaran' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 7h16v10H4V7Zm0 3h16M7 15h4"/></svg>',
                'E-Book' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 4h10a2 2 0 0 1 2 2v14H8a2 2 0 0 1-2-2V4Zm3 0v14a2 2 0 0 0 2 2m-1-12h5m-5 4h5"/></svg>',
                'Appointment' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 4v3m10-3v3M5 8h14v12H5V8Zm3 4h3v3H8v-3Z"/></svg>',
                'Janji Temu' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 4v3m10-3v3M5 8h14v12H5V8Zm3 4h3v3H8v-3Z"/></svg>',
                'Jadwal' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 5h14v14H5V5Zm0 4h14M9 3v4m6-4v4m-7 8h3m3 0h2"/></svg>',
                'Progress' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 19V5m0 14h14M9 16v-4m4 4V8m4 8v-6"/></svg>',
                'Edukasi' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 5.5A2.5 2.5 0 0 1 6.5 3H11v17H6.5A2.5 2.5 0 0 0 4 22V5.5Zm9-2.5h4.5A2.5 2.5 0 0 1 20 5.5V22a2.5 2.5 0 0 0-2.5-2H13V3Z"/></svg>',
                'Buku' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 4h10a2 2 0 0 1 2 2v14H8a2 2 0 0 1-2-2V4Zm3 0v14a2 2 0 0 0 2 2m-1-12h5m-5 4h5"/></svg>',
                'Buku Saya' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M6 4h10a2 2 0 0 1 2 2v14H8a2 2 0 0 1-2-2V4Zm4 4h5m-5 4h5m-5 4h3"/></svg>',
                'Konsultasi' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm-6 8a6 6 0 0 1 12 0M19 8h2m-1-1v2"/></svg>',
                'Notifikasi' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M18 16v-5a6 6 0 1 0-12 0v5l-2 2h16l-2-2Zm-8 4h4"/></svg>',
                'Profil Saya' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8Zm-7 8a7 7 0 0 1 14 0"/></svg>',
                'Default' => '<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 12h14M12 5v14"/></svg>',
            ];
        @endphp
    @else
        @php
                ...
                <div class="flex h-[calc(100vh-1.5rem)] flex-col overflow-hidden rounded-r-2xl border border-l-0 border-[#1A1A1A]/10 bg-white text-[#1A1A1A] shadow-[12px_0_40px_rgba(0,0,0,0.08)] transition-all duration-500"
                    ...
                    <div class="border-t border-[#1A1A1A]/10 p-3">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="flex h-10 w-full items-center rounded-lg px-3 text-sm text-red-700 transition-colors duration-300 hover:bg-red-700/5">
